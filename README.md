...
Plots are generated by running the analysis script for each environment. The script supports custom input and output directories (defaulting to `data/csv`):
