"""Launch Gazebo Classic + TurtleBot3 Burger + Nav2 in the OFFICIAL obstacles world.
...
def generate_launch_description():
    ...
    world_file  = os.path.join(turtlebot3_gazebo, 'worlds', 'turtlebot3_world.world')
    nav2_params = os.path.join(pkg_share, 'config', 'nav2_params_obstacles.yaml')
    map_file    = '/ros2_ws/maps/obstacles_map.yaml'
